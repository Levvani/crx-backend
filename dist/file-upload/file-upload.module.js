...
exports.FileUploadModule = FileUploadModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: file_entry_schema_1.FileEntry.name, schema: file_entry_schema_1.FileEntrySchema }])
        ],
        controllers: [file_upload_controller_1.FileUploadController],
        providers: [file_upload_service_1.FileUploadService, file_entry_repository_1.FileEntryRepository],
